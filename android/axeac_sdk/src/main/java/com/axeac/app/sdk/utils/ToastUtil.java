...
public class ToastUtil {
	...
	private static Runnable r = new Runnable() {
		public void run() {
			if(mToast != null) {
				mToast.cancel();
                // After toast is hidden, set it to null
                // toast隐藏后，将其置为null
				mToast = null;
			}
		}
